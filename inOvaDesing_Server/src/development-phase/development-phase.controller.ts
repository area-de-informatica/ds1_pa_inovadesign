...
export class DevelopmentPhaseController {
  constructor(private readonly developmentPhaseService: DevelopmentPhaseService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDevelopmentPhaseDto: UpdateDevelopmentPhaseDto) {
